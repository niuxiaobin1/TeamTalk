...
import com.mogujie.tt.imservice.manager.IMFileReceiveSocketManager;
...
public class FileReceiveServerHandler extends SimpleChannelHandler {

    private Logger logger = Logger.getLogger(FileReceiveServerHandler.class);
	...
	public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e)
        ...
        IMFileReceiveSocketManager.instance().onFileServerConnected();
	}
	...
	public void channelDisconnected(ChannelHandlerContext ctx,
        ...
        IMFileReceiveSocketManager.instance().onFileServerDisconn();
	}
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
        ...
        if(null!=channelBuffer)
            IMFileReceiveSocketManager.instance().packetDispatch(channelBuffer);
	}
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e) throws Exception {
        ...
        if(e.getChannel() == null || !e.getChannel().isConnected()){
            IMFileReceiveSocketManager.instance().onConnectFileServerFail();
        }

...
public class RedPacketRenderView extends BaseMsgRenderView {
    ...
    public static RedPacketRenderView inflater(Context context, ViewGroup viewGroup, boolean isMine) {
        int resource = isMine ? R.layout.tt_mine_red_packet_message_item : R.layout.tt_other_red_packet_message_item;

        RedPacketRenderView textRenderView = (RedPacketRenderView) LayoutInflater.from(context).inflate(resource, viewGroup, false);

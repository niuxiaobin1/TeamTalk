...
public class SoftKeyBoardUtil {
    ...
    private static SharedPreferences preferences = AppContext.getAppContext().getSharedPreferences(SysConstant.UI_PARAMS, Context.MODE_PRIVATE);
    private static InputMethodManager imm = (InputMethodManager) AppContext.getAppContext().getSystemService(Context.INPUT_METHOD_SERVICE);
        ...
        ViewTreeObserver.OnGlobalLayoutListener listener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (rootViewVisibleHeight - visibleHeight > 200) {
                    ...
                    preferences.edit().putInt(SysConstant.SOFT_KEY_BOARD_HEIGHT, softKeyBoardHeight).apply();
                    return;
                }
    ...
    public static int getSoftKeyBoardHeight() {
        ...
        softKeyBoardHeight = preferences.getInt(SysConstant.SOFT_KEY_BOARD_HEIGHT, 0);
        if (softKeyBoardHeight == 0) {
    ...
    public static int[] getScreenSize() {
        int size[] = new int[2];
        DisplayMetrics dm = AppContext.getAppContext().getResources().getDisplayMetrics();
